...
const seriesData: Series[] = [
  ...
  },
  {
    ...
    params: {
      ...
      period: { value: 55, affectsCompute: true, min: 1, max: 200, step: 1 },
      lineWidth: 1,
    },
  ...
  },
  {
    ...
    params: {
      ...
      layer: "foreground",
      color: "#9C27B0",
      priceTagColor: "#9C27B0",
      period: { value: 14, affectsCompute: true, min: 1, max: 200, step: 1 },
      lineWidth: 1,
      showPct: false,
      showTR: true,
    },
  ...
  <div class="backtesting-toolbar">
    ...
    <div class="backtesting-toolbar-controls">
      ...
      >
        ...
        <template #body>
          <StatsPanel :dashboard="tabStore.globalState" />
        </template>
      </UModal>
